...
class Mineral(models.Model):
    """Mineral class model to create minerals"""
    ...
    # Using .get instead of directly calling the dictionary value
    # in case a key for a rock is not available and that raises a key error
    # here we just provide an empty string to the database
    @classmethod
    def add_minerals_to_database(cls):
        """Method to load initial mineral data from json file"""
